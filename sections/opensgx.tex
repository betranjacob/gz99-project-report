...
invoke system calls\footnotemark; OpenSGX specifies an interface
called a trampoline/stub which allows an enclave program to invoke
\texttt{libc} functions. The interface works as follows:
\begin{enumerate}
