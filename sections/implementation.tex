...
%the implementation section needs to cover things like:
%- We used openSGX, and therefore could not do XYZ and therefore had to do PQR
%- We implemented that enclave as a second process, isolated from
%NGINX/LibreSSL. What are the reasons behind that.
%- We used named pipes as opposed to sockets/other IPC constructs, why did we do
%that
%- Details on the specific ciphers we support, and why we did not support other
%ciphers
\begin{document}
