...
component.
% TODO: We used openSGX, and therefore could not do XYZ and therefore had to do
%   PQR >>>  "technically, we couldn't use it to do enclave + untrusted in one
%   process, but that's more of us not using their trampoline/stub than
%   anything", also
%   "opensgx also made the perf eval more difficult because the simulation
%   doesn't take into account things like number of cycles in an SGX
%   instruction etc. and I guess that would refer to the perf eval section
%
% TODO: We implemented that enclave as a second process, isolated from
%       NGINX/LibreSSL. What are the reasons behind that.
% TODO: Mention issues with the provisioning mechanishm
% TODO: Mention returning of IV/nonce to the untrusted part
% TODO: OpenSGX, anything interesting that not mentioned in the previous
% sections ???
